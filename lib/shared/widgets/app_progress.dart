        ...
        Container(
          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              final fillWidth = (constraints.maxWidth * progress).clamp(36.0, constraints.maxWidth);
              return Stack(
                children: [
                  Align(
                    ...
                    child: AnimatedContainer(
                      ...
                      width: progress == 0 ? 0 : fillWidth,
                      decoration: BoxDecoration(
                        gradient: AppColors.accentGradient,
                        borderRadius: BorderRadius.circular(20),
                        boxShadow: [
                          BoxShadow(
                            color: AppColors.accentFrom.withValues(alpha: 0.35),
                            blurRadius: 10,
                      ...
                      child: Align(
                        ...
                        child: Text(
                          ...
                          style: text.labelLarge?.copyWith(
                            ...
                            color: progress > 0.72 ? AppColors.onNeon : AppColors.navy,
                          ),
                        ),
                      ),
                    ),
